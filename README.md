...
| 42 | [이진 트리의 최대 깊이](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | ★ | 14장. 트리 | [42taelee(DFS).py](solutions/08tree/42taelee(DFS).py)<BR>[42taelee(BFS).py (다시풀기)](solutions/08tree/42taelee(BFS).py)<BR> |
...
| 56 | [트라이 구현](https://leetcode.com/problems/implement-trie-prefix-tree/) | ★★ | 16장. 트라이 | [56taelee.py](solutions/10trie/56taelee.py)</br>[56taelee(binary_search).py](solutions/10trie/56taelee(binary_search).py)</br>[56jehong.py](solutions/10trie/56jehong.py) |
