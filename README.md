...
| 13 | [팰린드롬 연결 리스트](https://leetcode.com/problems/palindrome-linked-list/) | ★ | 8장. 연결 리스트 | [13taelee.py](solutions/02LinkedList/13taelee.py) </br>[13jehong.py](solutions/02/LinkedList/13jehong.py)|
