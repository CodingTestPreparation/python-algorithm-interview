...
| 2    | [문자열 뒤집기](https://leetcode.com/problems/reverse-string/) | ★      | 6장. 문자열 조작         | [02taelee.py](solutions/00string/02taelee.py)</br> [02jehong.py](solutions/00string/02jehong.py)</br>[02secho.py](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/00string/02secho.js) |
...
| 7    | [두 수의 합](https://leetcode.com/problems/two-sum/)         | ★      | 7장. 배열                | [07jehong.py](solutions/01array/07jehong.py)</br>[07taelee.py](solutions/01array/07taelee.py)</br>[07secho.py](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/01array/07secho.py) |
| 8    | [빗물 트래핑](https://leetcode.com/problems/trapping-rain-water/) | ★★★    | 7장. 배열                |                                                              |
| 9    | [세 수의 합](https://leetcode.com/problems/3sum/)            | ★★     | 7장. 배열                | [09jehong.py](solutions/01array/09jehong.py) </br>[09secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/01array/09secho.js) </br>[09secho.py](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/01array/09secho.py) |
| 10   | [배열 파티션 I](https://leetcode.com/problems/array-partition-i/) | ★      | 7장. 배열                | [10taelee.py](solutions/01array/10taelee.py)<br>[10jehong.py](solutions/01array/10jehong.py)</br>[10secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/01array/10secho.js) |
| 11   | [자신을 제외한 배열의 곱](https://leetcode.com/problems/product-of-array-except-self/) | ★★     | 7장. 배열                | [11jehong.py](solutions/01array/11jehong.py)<br>[11taelee.py](solutions/01array/11taelee.py)<br>[11taelee.swift](solutions/01array/11taelee.swift) |
| 12   | [주식을 사고팔기 가장 좋은 시점](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | ★      | 7장. 배열                | [12jehong.py](solutions/01array/12jehong.py) </br>[12secho.py](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/01array/12secho.js) |
...
| 20   | [유효한 괄호](https://leetcode.com/problems/valid-parentheses/) | ★      | 9장. 스택, 큐            | [20jehong.py](solutions/03stack,queue/20jehong.py) </br> [20taelee.py](solutions/03stack,queue/20taelee.py)</br>[20secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/03stack,queue/20secho.js) |
| 21   | [중복 문자 제거](https://leetcode.com/problems/remove-duplicate-letters/) | ★★★    | 9장. 스택, 큐            | [21jehong.py](solutions/03stack,queue/21jehong.py) </br> [21taelee.py](solutions/03stack,queue/21taelee.py)</br>[21secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/03stack,queue/21secho.js) |
| 22   | [일일 온도](https://leetcode.com/problems/daily-temperatures/) | ★★     | 9장. 스택, 큐            | [22taelee(다시풀기).py](solutions/03stack,queue/22taelee.py)</br>[22jehong.py](solutions/03stack,queue/22jehong.py)</br>[22secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/03stack%2Cqueue/22secho.js) |
...
| 29   | [보석과 돌](https://leetcode.com/problems/jewels-and-stones/) | ★      | 11장. 해시 테이블        | [29secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/05hashTable/29secho.js) |
| 30   | [중복 문자 없는 가장 긴 부분 문자열](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | ★★     | 11장. 해시 테이블        | [30secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/05hashTable/30secho.js) |
| 31   | [상위 K 빈도 요소](https://leetcode.com/problems/top-k-frequent-elements/) | ★★     | 11장. 해시 테이블        | [31secho.js](https://github.com/CodingTestPreparation/python-algorithm-interview/blob/main/solutions/05hashTable/31secho.js) |
| 32   | [섬의 개수](https://leetcode.com/problems/number-of-islands/) | ★★     | 12장. 그래프             | [32jehong_dfs.py](solutions/06graph/32jehong.py)<br>[32taelee.py](solutions/06graph/33taelee.py)</br>[32secho.js](solutions/06graph/32secho.js) |
| 33   | [전화 번호 문자 조합](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) | ★★     | 12장. 그래프             | [33jehong_dfs.py](solutions/06graph/32jehong.py) </br>[33secho.js](solutions/06graph/33secho.js) |
...
| 45   | [이진 트리 반전](https://leetcode.com/problems/invert-binary-tree/) | ★      | 14장. 트리               | [45taelee(DFS).py(다시풀기)](solutions/08tree/45taelee(DFS).py)<BR>[45taelee(BFS).py (다시풀기)](solutions/08tree/45taelee(BFS).py)<BR> |
...
| 65   | [이진 검색](https://leetcode.com/problems/binary-search/)    | ★      | 18장. 이진 검색          | [65taelee.swift](solutions/12binarySearch/65taelee.swift) </br>[65jehong.py](solutions/12binarySearch/65jehong.py) |
...
| 78   | [주식을 사고 팔기 가장 좋은 시점 II](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/) | ★      | 21장. 그리디 알고리즘    | [78jehong.py](solutions/15greedy/78jehong.py)<br/>[78taelee.py](solutions/15greedy/78taelee.py) |
| 79   | [키에 따른 대기열 재구성](https://leetcode.com/problems/queue-reconstruction-by-height/) | ★★     | 21장. 그리디 알고리즘    | [79jehong.py(다시 풀기)](solutions/15greedy/79jehong.py)<br/>[79taelee(다시풀기).py](solutions/15greedy/79taelee.py) |
...
| 82         | [쿠키 부여](https://leetcode.com/problems/assign-cookies/)   | ★      | 21장. 그리디 알고리즘         | [82jehong.py](solutions/15greedy/82jehong.py)<br/>[82taelee.py](solutions/15greedy/82taelee.py)<br/>[82taelee2.py](solutions/15greedy/82taelee2.py)<br/> |
