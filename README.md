...
| 56 | [트라이 구현](https://leetcode.com/problems/implement-trie-prefix-tree/) | ★★ | 16장. 트라이 | [56taelee.py](solutions/10trie/56taelee(binary_search).py)</br>[56jehong.py](solutions/10trie/56jehong.py) |
